        ...
        <div class="row s-header__content">
            ...
            <div class="s-header__logo">
                <a class="logo" href="index.html">
                    <g-image src="~/../static/images/logo.svg" alt="Homepage" />
                </a>
            </div>
        ...
        <div class="masonry">
            <div class="bricks-wrapper h-group">
                ...
                <article class="brick entry format-standard animate-this">
                    ...
                    <div class="entry__thumb">
                        <a href="single-standard.html" class="thumb-link">
                            <g-image src="~/../static/images/thumbs/masonry/woodcraft-600.jpg" 
                                 />
                        </a>
                ...
                <article class="brick entry format-standard animate-this">
                    ...
                    <div class="entry__thumb">
                        <a href="single-standard.html" class="thumb-link">
                            <g-image src="~/../static/images/thumbs/masonry/tulips-600.jpg" 
                                 />
                        </a>
                    </div>  <!-- end entry__thumb -->
                ...
                <article class="brick entry format-standard animate-this">
                    ...
                    <div class="entry__thumb">
                        <a href="single-standard.html" class="thumb-link">
                            <g-image src="~/../static/images/thumbs/masonry/dew-600.jpg" 
                                 />
                        </a>
                    </div> <!-- end entry__thumb -->
                ...
                <article class="brick entry format-quote animate-this" >
                    ...
                    <div class="entry__thumb">
                        <blockquote>
                            <p>The inevitable trajectory of all software is death.</p>
    
                            <cite>Brendan Burns</cite>
                            <cite>Co-founder, Kubernetes</cite>
                        </blockquote>
                    </div>
                ...
                <article class="brick entry format-standard animate-this">
                    ...
                    <div class="entry__thumb">
                        <a href="single-standard.html" class="thumb-link">
                            <g-image src="~/../static/images/thumbs/masonry/rucksack-600.jpg" 
                                 />
                        </a>
                    </div> <!-- end entry__thumb -->
                ...
                <article class="brick entry format-standard animate-this" >
                    ...
                    <div class="entry__thumb">
                        <a href="single-standard.html" class="thumb-link">
                            <g-image src="~/../static/images/thumbs/masonry/jump-600.jpg" 
                                 />
                        </a>
                    </div> <!-- end entry__thumb -->
                    ...
                    <div class="entry__thumb slider">
                            <div class="slider__slides">
                                <div class="slider__slide">
                                    <g-image src="~/../static/images/thumbs/masonry/gallery/slide-1-600.jpg" alt="" /> 
                                </div>
                                <div class="slider__slide">
                                    <g-image src="~/../static/images/thumbs/masonry/gallery/slide-2-600.jpg" 
                                         />
                                </div>
                                <div class="slider__slide">
                ...
                <article class="brick entry format-audio animate-this">
                    ...
                    <div class="entry__thumb">
                        <a href="single-audio.html" class="thumb-link">
                            <g-image src="~/../static/images/thumbs/masonry/guitarist-600.jpg" 
                                 />
                        </a>
                    </div> <!-- end entry--thumb -->
                ...
                <article class="brick entry format-video animate-this">
                    ...
                    <div class="entry__thumb video-image">
                        <a href="https://player.vimeo.com/video/117310401?color=ffffff&title=0&byline=0&portrait=0" data-lity  class="thumb-link">
                            <g-image src="~/../static/images/thumbs/masonry/cookies-600.jpg" 
                                 />
                        </a>
                    </div> <!-- end entry__thumb -->
                 ...
                 <article class="brick entry format-standard animate-this">
                    ...
                    <div class="entry__thumb">
                        <a href="single-standard.html" class="thumb-link">
                            <g-image src="~/../static/images/thumbs/masonry/walk-600.jpg" 
                                 />
                        </a>
                    </div> <!-- end entry__thumb -->
                ...
                <article class="brick entry format standard animate-this">
                    ...
                    <div class="entry__thumb">
                        <a href="single-standard.html" class="thumb-link">
                            <g-image src="~/../static/images/thumbs/masonry/lamp-600.jpg" 
                                 />
                        </a>
                    </div> <!-- end entry__thumb -->
                 ...
                 <article class="brick entry format-standard animate-this">
                    ...
                    <div class="entry__thumb">
                        <a href="single-standard.html" class="thumb-link">
                            <g-image src="~/../static/images/thumbs/masonry/real-600.jpg" 
                                 />
                        </a>
                    </div> <!-- end entry__thumb -->
                 ...
                 <article class="brick entry format-standard animate-this">
                    ...
                    <div class="entry__thumb">
                        <a href="single-standard.html" class="thumb-link">
                            <g-image src="~/../static/images/thumbs/masonry/beetle-600.jpg" 
                                 />
                        </a>
                    </div> <!-- end entry__thumb -->
                 ...
                 <article class="brick entry format-standard animate-this">
                    ...
                    <div class="entry__thumb">
                        <a href="single-standard.html" class="thumb-link">
                            <g-image src="~/../static/images/thumbs/masonry/seashore-600.jpg" 
                                 />
                        </a>
                    </div> <!-- end entry__thumb -->
